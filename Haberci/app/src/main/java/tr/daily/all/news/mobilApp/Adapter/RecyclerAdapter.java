package tr.daily.all.news.mobilApp.Adapter;
...
import tr.daily.all.news.mobilApp.Common;
import tr.daily.all.news.mobilApp.MainActivity;
import tr.daily.all.news.mobilApp.Models.Article;
import tr.daily.all.news.mobilApp.NewsItemClickListener;
import tr.daily.all.news.mobilApp.R;

//Tableview için gerekli adapter yazılımı.
